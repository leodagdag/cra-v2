...
public class JDay extends Model implements MongoModel {
    ...
    public static List<JDay> find(final JCra cra, final Boolean withPastAndFuture) {
        final List<DateTime> allDates = Lists.newArrayList(TimeUtils.getDaysOfMonth(cra.year, cra.month, withPastAndFuture));
        final List<JDay> days = q()
