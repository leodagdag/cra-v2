app.controller('MyAccountCtrl', ['$scope', '$http', '$log', '$location', '$routeParams',
	function MyAccountCtrl($scope, $http, $log, $location, $routeParams) {
		$scope.subSections = {
			'general': 'public/views/my-account/general.html',
			'vehicle': 'public/views/my-account/vehicle.html',
			'affected-missions': 'public/views/my-account/affected-missions.html',
			'part-time': 'public/views/my-account/part-time.html'
		};
