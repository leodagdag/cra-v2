...
class TimeUtilsSpec extends Specification {
  ...
  "TimeUtils.nbDaysOffInMonth" should {
    "in January 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, JANUARY)
      nbDaysOffInMonth must beEqualTo(1)
    }
    "in February 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, FEBRUARY)
      nbDaysOffInMonth must beEqualTo(0)
    }
    "in March 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, MARCH)
      nbDaysOffInMonth must beEqualTo(1)
    }
    "in April 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, APRIL)
      nbDaysOffInMonth must beEqualTo(1)
    }
    "in May 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, MAY)
      nbDaysOffInMonth must beEqualTo(5)
    }
    "in June 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, JUNE)
      nbDaysOffInMonth must beEqualTo(0)
    }
    "in July 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, JULY)
      nbDaysOffInMonth must beEqualTo(1)
    }
    "in August 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, AUGUST)
      nbDaysOffInMonth must beEqualTo(1)
    }
    "in September 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, SEPTEMBER)
      nbDaysOffInMonth must beEqualTo(0)
    }
    "in October 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, OCTOBER)
      nbDaysOffInMonth must beEqualTo(0)
    }
    "in November 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, NOVEMBER)
      nbDaysOffInMonth must beEqualTo(2)
    }
    "in December 2013" in {
      val nbDaysOffInMonth = TimeUtils.nbDaysOffInMonth(2013, DECEMBER)
      nbDaysOffInMonth must beEqualTo(1)
    }
  }
  ...
  "TimeUtils.dateRange" should {
    "previousWorkingDay of 01/05/2013 is equal to 30/04/2013" in {
      val previousWorkingDay = TimeUtils.previousWorkingDay(new DateTime(2013, DateTimeConstants.MAY, 1, 0, 0, 0, 0))
      previousWorkingDay.getYear must beEqualTo(2013)
      previousWorkingDay.getMonthOfYear must beEqualTo(DateTimeConstants.APRIL)
      previousWorkingDay.getDayOfMonth must beEqualTo(30)
    }
    "previousWorkingDay of 30/04/2013 is equal to 30/04/2013" in {
      val previousWorkingDay = TimeUtils.previousWorkingDay(new DateTime(2013, DateTimeConstants.APRIL, 30, 0, 0, 0, 0))
      previousWorkingDay.getYear must beEqualTo(2013)
      previousWorkingDay.getMonthOfYear must beEqualTo(DateTimeConstants.APRIL)
      previousWorkingDay.getDayOfMonth must beEqualTo(30)
    }
    "nextWorkingDay of 01/05/2013 must equal to 02/05/2013" in {
      val previousWorkingDay = TimeUtils.nextWorkingDay(new DateTime(2013, DateTimeConstants.MAY, 1, 0, 0, 0, 0))
      previousWorkingDay.getYear must beEqualTo(2013)
      previousWorkingDay.getMonthOfYear must beEqualTo(DateTimeConstants.MAY)
      previousWorkingDay.getDayOfMonth must beEqualTo(2)
    }
    "nextWorkingDay of 02/05/2013 must equal to 02/05/2013" in {
      val previousWorkingDay = TimeUtils.nextWorkingDay(new DateTime(2013, DateTimeConstants.MAY, 2, 0, 0, 0, 0))
      previousWorkingDay.getYear must beEqualTo(2013)
      previousWorkingDay.getMonthOfYear must beEqualTo(DateTimeConstants.MAY)
      previousWorkingDay.getDayOfMonth must beEqualTo(2)
    }
