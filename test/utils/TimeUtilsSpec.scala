...
class TimeUtilsSpec extends Specification {
	...
	"TimeUtils.datesBetween" should {
		...
		"01/02/2013->04/02/2013 with dayOff" in {
			val datesOfWeek = TimeUtils.datesBetween(new DateTime(2013,FEBRUARY,1,0,0), new DateTime(2013,FEBRUARY,4,0,0), false)
			datesOfWeek.size() must beEqualTo(2)
		}
		"04/02/2013->08/02/2013 with dayOff" in {
			val datesOfWeek = TimeUtils.datesBetween(new DateTime(2013,FEBRUARY,4,0,0), new DateTime(2013,FEBRUARY,8,0,0), false)
